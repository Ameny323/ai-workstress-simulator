...
export default function TaskCard() {
  ...
  const handleComplete = () => {
    setCompleting(true);
    setTimeout(() => { completeTask(); setCompleting(false); }, 800);
  };
  ...
  return (
    ...
    >
      ...
      >
        Analyze Q3 revenue performance across all business units, identify variance drivers, and prepare
        an executive-ready summary. Focus on the 14.2% shortfall in EMEA and cross-reference with the
        adjusted forecasts submitted by regional leads. Highlight risks for Q4 planning.
      </div>

      {/* Meta row: Deadline + Remaining + Duration */}
      ...
      <button
        ...
        style={{
          ...
          background: completing
            ? "rgba(34,197,94,0.15)"
            : "linear-gradient(135deg, #5B84C6 0%, #8D74FF 100%)",
